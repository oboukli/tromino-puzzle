...
// | - + |
// + - - +
BOOST_AUTO_TEST_CASE(Given_solve_tromino_puzzle_WhenOrderIs4AndMarkIs0_0_ThenSolution)
{
...
BOOST_AUTO_TEST_CASE(Given_solve_tromino_puzzle_WhenOrderIs4AndMarkIs0_7_ThenSolution)
{
    constexpr int order = 4;
...
BOOST_AUTO_TEST_CASE(Given_solve_tromino_puzzle_WhenOrderIs4AndMarkIs7_0_ThenSolution)
{
    constexpr int order = 4;
...
BOOST_AUTO_TEST_CASE(Given_solve_tromino_puzzle_WhenOrderIs4AndMarkIs7_7_ThenSolution)
{
    constexpr int order = 4;
